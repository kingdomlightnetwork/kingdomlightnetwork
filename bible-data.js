...
IMPORTANT:
This file contains the Bible data currently available in
the project. More complete Bible text can be added later
without changing the Bible Research engine.
===========================================================
*/
...
(function () {
    ...
    function getBibleDatabase(language) {
        ...
        if (BIBLE_DATABASE[lang]) {
            return BIBLE_DATABASE[lang];
        }

        return BIBLE_DATABASE[DEFAULT_BIBLE_LANGUAGE];
    }
    ...
    function getBibleLanguageInfo(language) {
        ...
        return BIBLE_LANGUAGES[lang] || BIBLE_LANGUAGES.en;
    }
    ...
    function getAllBibleLanguages() {
        ...
        return Object.keys(BIBLE_LANGUAGES).map(function (code) {

            return {
                code: code,
                name: BIBLE_LANGUAGES[code].name,
                nativeName: BIBLE_LANGUAGES[code].nativeName,
                direction: BIBLE_LANGUAGES[code].direction,
                available: BIBLE_LANGUAGES[code].available
            };
    ...
    function getBibleVerse(
        ...
        const testamentData = database[testament];
    ...
    function getBibleAvailableVerses(
        ...
        const chapterData = getBibleChapter(
            language,
            testament,
            book,
            chapter
    ...
    window.DEFAULT_BIBLE_LANGUAGE = DEFAULT_BIBLE_LANGUAGE;
    ...
    window.getBibleAvailableVerses = getBibleAvailableVerses;

    window.normalizeBibleLanguage = normalizeBibleLanguage;
    ...
    document.dispatchEvent(
        new CustomEvent("bibleDataSystemReady")
    );
